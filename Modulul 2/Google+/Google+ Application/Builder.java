...
public class Builder {
	...
	JsonArray jsonArrayOfItems1; // se extrage tagul "items" din Json ca vector de perechi cheie-valoare
	JsonArray jsonArrayOfItems2;
	JsonValue userName; // se extrage valoarea tagului "displayName"
	JsonObjectBuilder interesBuilder; // construieste perechea {"interes": "valoare"}
	JsonObjectBuilder shortTermInterestBuilder; // construieste lista de perechi interes:valoare
    ...
    for (JsonObject result :jsonArrayOfItems2.getValuesAs(JsonObject.class)) {
   	 listaInterese2.add(result.getString("annotation", ""));
